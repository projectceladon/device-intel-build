...
public class Utils {
    ...
    /* New version of sign() to support passing a specific signing algorithm
     * instead of using a default.
     */
    static byte[] sign(PrivateKey privateKey, String algorithm, byte[] input) throws Exception {
    ...
    /* Version of sign() with original signature to avoid breaking compatibility
     */
    static byte[] sign(PrivateKey privateKey, byte[] input) throws Exception {
        return sign(privateKey, "SHA1withRSA", input);
    }
